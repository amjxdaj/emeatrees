...
const AddTree = () => {
  ...
  const [formData, setFormData] = useState<TreeFormData>({
    ...
    native_range: '',
    species: '',
    location: 'EMEA College', // Default location
    description: '',
    image: null,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Derive name and species from scientific_name if not provided
    const updatedFormData = {
      ...formData,
      name: formData.name.trim() || formData.scientific_name.trim(),
      species: formData.species.trim() || formData.scientific_name.trim()
    };
    
    setLoading(true);
    
    try {
      const response = await addTree(updatedFormData);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in">
            <div>
              <div className="glass-card p-6 rounded-xl mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium">{newTree.scientific_name}</h3>
                  </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-6 text-sm text-muted-foreground">
                ...
                <p>
                  When scanned, visitors will be taken directly to a page where they can learn more about {newTree.scientific_name}.
                </p>
                {newTree.pendingImage && (
